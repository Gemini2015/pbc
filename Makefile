...
TESTSRCS = addressbook.c pattern.c pbc.c float.c map.c test.c decode.c test64.c
PROTOSRCS = addressbook.proto descriptor.proto float.proto test.proto test64.proto
